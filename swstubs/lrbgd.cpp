...
void p_0_bgd_accel_1_noasync(float * valData, float * valWeight, float * valGradient)
{
  int start_seq[1];
  start_seq[0] = 0;
  cf_request_handle_t p_0_hwinst_bgd_accel_1_cmd;
  cf_send_i(&(p_0_hwinst_bgd_accel_1.cmd_bgd_accel), start_seq, 1 * sizeof(int), &p_0_hwinst_bgd_accel_1_cmd);
  cf_wait(p_0_hwinst_bgd_accel_1_cmd);
