...
wire   [13:0] mul_ln545_fu_293_p2;
reg   [13:0] mul_ln545_reg_462;
wire   [2:0] m_fu_310_p2;
wire    ap_CS_fsm_state2;
wire   [2:0] m_7_fu_337_p2;
reg   [2:0] m_7_reg_482;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln544_fu_331_p2;
reg   [2:0] fltDotTmp_addr_7_reg_497;
wire   [9:0] fe0_fu_378_p2;
reg   [31:0] pfltWeight_load_reg_507;
wire   [2:0] m_8_fu_395_p2;
reg   [2:0] m_8_reg_515;
wire    ap_CS_fsm_state16;
wire   [0:0] icmp_ln550_fu_389_p2;
wire   [31:0] bitcast_ln557_1_fu_411_p1;
wire   [63:0] grp_fu_249_p2;
reg   [63:0] tmp_22_reg_530;
wire    ap_CS_fsm_state41;
wire   [63:0] grp_fu_244_p2;
reg   [63:0] tmp_24_reg_535;
wire   [31:0] grp_fu_233_p1;
reg   [31:0] fltDif_reg_540;
wire    ap_CS_fsm_state88;
wire    ap_CS_fsm_state89;
reg   [12:0] pfltGradient_addr_reg_550;
wire   [9:0] fe0_4_fu_451_p2;
reg   [9:0] fe0_4_reg_558;
...
reg   [2:0] m_0_reg_156;
wire   [0:0] icmp_ln534_fu_304_p2;
reg   [9:0] fe0_0_reg_167;
reg   [2:0] m1_0_reg_179;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln540_fu_316_p2;
wire    ap_CS_fsm_state15;
reg   [31:0] fltDot_0_reg_190;
reg   [2:0] m2_0_reg_202;
reg   [9:0] fe03_0_reg_213;
wire    ap_CS_fsm_state100;
wire   [31:0] zext_ln534_fu_299_p1;
wire  signed [31:0] sext_ln545_fu_362_p1;
wire   [31:0] zext_ln545_3_fu_373_p1;
wire   [31:0] zext_ln544_1_fu_326_p1;
wire   [31:0] zext_ln550_fu_384_p1;
wire   [31:0] zext_ln564_2_fu_430_p1;
wire  signed [31:0] sext_ln564_fu_440_p1;
...
wire   [3:0] mul_ln545_fu_293_p0;
wire   [9:0] zext_ln544_fu_322_p1;
wire   [9:0] add_ln545_fu_343_p2;
wire   [13:0] zext_ln545_2_fu_353_p1;
wire   [13:0] add_ln545_1_fu_357_p2;
wire   [10:0] zext_ln545_1_fu_349_p1;
wire   [10:0] add_ln545_2_fu_367_p2;
wire   [31:0] bitcast_ln557_fu_401_p1;
wire   [31:0] xor_ln557_fu_405_p2;
wire   [10:0] zext_ln564_1_fu_420_p1;
wire   [10:0] add_ln564_fu_424_p2;
wire   [13:0] zext_ln564_fu_416_p1;
wire   [13:0] add_ln564_1_fu_435_p2;
reg   [1:0] grp_fu_239_opcode;
wire   [0:0] icmp_ln561_fu_445_p2;
reg   [99:0] ap_NS_fsm;
wire   [13:0] mul_ln545_fu_293_p00;
...
a3_bgd_accel_fadd_32ns_32ns_32_5_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
bgd_accel_fadd_32ns_32ns_32_5_full_dsp_1_U21(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_224_p0),
    .din1(grp_fu_224_p1),
...
a3_bgd_accel_fmul_32ns_32ns_32_4_max_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
bgd_accel_fmul_32ns_32ns_32_4_max_dsp_1_U22(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_229_p0),
    .din1(reg_254),
...
a3_bgd_accel_fptrunc_64ns_32_2_1 #(
    ...
    .din0_WIDTH( 64 ),
    .dout_WIDTH( 32 ))
bgd_accel_fptrunc_64ns_32_2_1_U23(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(reg_283),
    .ce(1'b1),
...
a3_bgd_accel_fpext_32ns_64_2_1 #(
    ...
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
bgd_accel_fpext_32ns_64_2_1_U24(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_236_p0),
    .ce(1'b1),
...
a3_bgd_accel_dadddsub_64ns_64ns_64_7_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
bgd_accel_dadddsub_64ns_64ns_64_7_full_dsp_1_U25(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_239_p0),
    .din1(grp_fu_239_p1),
...
a3_bgd_accel_ddiv_64ns_64ns_64_31_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
bgd_accel_ddiv_64ns_64ns_64_31_1_U26(
    .clk(ap_clk),
    .reset(ap_rst),
...
a3_bgd_accel_dexp_64ns_64ns_64_18_full_dsp_1 #(
    ...
    .din1_WIDTH( 64 ),
    .dout_WIDTH( 64 ))
bgd_accel_dexp_64ns_64ns_64_18_full_dsp_1_U27(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(64'd0),
    .din1(reg_277),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln534_fu_304_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        fe0_0_reg_167 <= 10'd0;
    end else if (((icmp_ln544_fu_331_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        fe0_0_reg_167 <= fe0_fu_378_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln540_fu_316_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln540_fu_316_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        m1_0_reg_179 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln534_fu_304_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state89)) begin
        ...
        pfltGradient_addr_reg_550 <= sext_ln564_fu_440_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln544_fu_331_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        fltDotTmp_addr_7_reg_497 <= zext_ln544_1_fu_326_p1;
    end
end
...
always @ (*) begin
    if ((((icmp_ln561_fu_445_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state89)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln561_fu_445_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state89))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state15) | ((icmp_ln534_fu_304_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
        fltDotTmp_we0 = 1'b1;
    end else begin
        fltDotTmp_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state89)) begin
        pfltData_address0 = zext_ln564_2_fu_430_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        pfltData_address0 = zext_ln545_3_fu_373_p1;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln544_fu_331_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state16 : begin
            if (((icmp_ln550_fu_389_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state16))) begin
...
assign add_ln545_1_fu_357_p2 = (mul_ln545_reg_462 + zext_ln545_2_fu_353_p1);

assign add_ln545_2_fu_367_p2 = (zext_ln545_1_fu_349_p1 + 11'd785);

assign add_ln545_fu_343_p2 = (fe0_0_reg_167 + zext_ln544_fu_322_p1);

assign add_ln564_1_fu_435_p2 = (mul_ln545_reg_462 + zext_ln564_fu_416_p1);

assign add_ln564_fu_424_p2 = (zext_ln564_1_fu_420_p1 + 11'd785);
...
assign bitcast_ln557_1_fu_411_p1 = xor_ln557_fu_405_p2;

assign bitcast_ln557_fu_401_p1 = fltDot_0_reg_190;

assign fe0_4_fu_451_p2 = (fe03_0_reg_213 + 10'd1);

assign fe0_fu_378_p2 = (fe0_0_reg_167 + 10'd5);

assign icmp_ln534_fu_304_p2 = ((m_0_reg_156 == 3'd5) ? 1'b1 : 1'b0);

assign icmp_ln540_fu_316_p2 = ((fe0_0_reg_167 < 10'd785) ? 1'b1 : 1'b0);

assign icmp_ln544_fu_331_p2 = ((m1_0_reg_179 == 3'd5) ? 1'b1 : 1'b0);

assign icmp_ln550_fu_389_p2 = ((m2_0_reg_202 == 3'd5) ? 1'b1 : 1'b0);

assign icmp_ln561_fu_445_p2 = ((fe03_0_reg_213 == 10'd785) ? 1'b1 : 1'b0);

assign m_7_fu_337_p2 = (m1_0_reg_179 + 3'd1);

assign m_8_fu_395_p2 = (m2_0_reg_202 + 3'd1);

assign m_fu_310_p2 = (m_0_reg_156 + 3'd1);

assign mul_ln545_fu_293_p0 = mul_ln545_fu_293_p00;

assign mul_ln545_fu_293_p00 = pfltWeight_offset;

assign mul_ln545_fu_293_p2 = (mul_ln545_fu_293_p0 * $signed('h311));

assign pfltGradient_address0 = pfltGradient_addr_reg_550;

assign pfltGradient_d0 = reg_270;

assign pfltWeight_address0 = sext_ln545_fu_362_p1;

assign sext_ln545_fu_362_p1 = $signed(add_ln545_1_fu_357_p2);

assign sext_ln564_fu_440_p1 = $signed(add_ln564_1_fu_435_p2);

assign xor_ln557_fu_405_p2 = (bitcast_ln557_fu_401_p1 ^ 32'd2147483648);

assign zext_ln534_fu_299_p1 = m_0_reg_156;

assign zext_ln544_1_fu_326_p1 = m1_0_reg_179;

assign zext_ln544_fu_322_p1 = m1_0_reg_179;

assign zext_ln545_1_fu_349_p1 = add_ln545_fu_343_p2;

assign zext_ln545_2_fu_353_p1 = add_ln545_fu_343_p2;

assign zext_ln545_3_fu_373_p1 = add_ln545_2_fu_367_p2;

assign zext_ln550_fu_384_p1 = m2_0_reg_202;

assign zext_ln564_1_fu_420_p1 = fe03_0_reg_213;

assign zext_ln564_2_fu_430_p1 = add_ln564_fu_424_p2;

assign zext_ln564_fu_416_p1 = fe03_0_reg_213;

endmodule //a3_bgd_func1
