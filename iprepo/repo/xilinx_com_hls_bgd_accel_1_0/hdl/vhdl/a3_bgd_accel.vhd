...
architecture behav of a3_bgd_accel is 
    ...
    component a3_bgd_accel_mac_muladd_11ns_14s_14ns_14_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component a3_bgd_accel_fltData IS
    generic (
        DataWidth : INTEGER;
    ...
    component a3_bgd_accel_fltLabel IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component a3_bgd_accel_fltWeight IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    fltData_U : component a3_bgd_accel_fltData
    generic map (
        DataWidth => 32,
        AddressRange => 3925,
        AddressWidth => 12)
    ...
    fltLabel_U : component a3_bgd_accel_fltLabel
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    fltWeight_U : component a3_bgd_accel_fltWeight
    generic map (
        DataWidth => 32,
        AddressRange => 7850,
        AddressWidth => 13)
    ...
    fltGradient_U : component a3_bgd_accel_fltWeight
    generic map (
        DataWidth => 32,
        AddressRange => 7850,
        AddressWidth => 13)
    ...
    grp_bgd_func4_fu_393 : component a3_bgd_func4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_bgd_func2_fu_403 : component a3_bgd_func2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_bgd_func3_fu_413 : component a3_bgd_func3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_bgd_func1_fu_423 : component a3_bgd_func1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_bgd_func0_fu_433 : component a3_bgd_func0
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    bgd_accel_mac_muladd_11ns_14s_14ns_14_1_1_U69 : component a3_bgd_accel_mac_muladd_11ns_14s_14ns_14_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 11,
    ...
    bgd_accel_mac_muladd_11ns_14s_14ns_14_1_1_U70 : component a3_bgd_accel_mac_muladd_11ns_14s_14ns_14_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 11,
