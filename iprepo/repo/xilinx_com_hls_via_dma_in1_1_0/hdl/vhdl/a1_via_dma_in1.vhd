...
architecture behav of a1_via_dma_in1 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "a1_via_dma_in1,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z045-ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=625,HLS_SYN_LUT=665,HLS_VERSION=2019_1}";
    ...
    signal icmp_ln22_reg_157_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln22_fu_134_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln22_fu_130_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component a1_via_dma_in1_in1_m_axi IS
    generic (
...
begin
    via_dma_in1_in1_m_axi_U : component a1_via_dma_in1_in1_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln22_fu_134_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln22_reg_157 <= icmp_ln22_fu_134_p2;
                icmp_ln22_reg_157_pp0_iter1_reg <= icmp_ln22_reg_157;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, weight_TREADY, weight_1_state, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, in1_ARREADY, icmp_ln22_fu_134_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_CS_fsm_state11)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln22_reg_157, in1_RVALID)
    begin
                ap_block_pp0_stage0_01001 <= ((in1_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln22_reg_157 = ap_const_lv1_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln22_reg_157, ap_enable_reg_pp0_iter2, in1_RVALID, ap_block_state9_io, ap_block_state10_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state10_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state9_io) or ((in1_RVALID = ap_const_logic_0) and (icmp_ln22_reg_157 = ap_const_lv1_1)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln22_reg_157, ap_enable_reg_pp0_iter2, in1_RVALID, ap_block_state9_io, ap_block_state10_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_const_boolean_1 = ap_block_state10_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state9_io) or ((in1_RVALID = ap_const_logic_0) and (icmp_ln22_reg_157 = ap_const_lv1_1)))));
    end process;


    ap_block_state10_io_assign_proc : process(weight_1_ack_in, icmp_ln22_reg_157_pp0_iter1_reg)
    begin
                ap_block_state10_io <= ((weight_1_ack_in = ap_const_logic_0) and (icmp_ln22_reg_157_pp0_iter1_reg = ap_const_lv1_1));
    end process;
    ...
    ap_block_state9_io_assign_proc : process(weight_1_ack_in, icmp_ln22_reg_157)
    begin
                ap_block_state9_io <= ((weight_1_ack_in = ap_const_logic_0) and (icmp_ln22_reg_157 = ap_const_lv1_1));
    end process;


    ap_block_state9_pp0_stage0_iter1_assign_proc : process(icmp_ln22_reg_157, in1_RVALID)
    begin
                ap_block_state9_pp0_stage0_iter1 <= ((in1_RVALID = ap_const_logic_0) and (icmp_ln22_reg_157 = ap_const_lv1_1));
    end process;


    ap_condition_pp0_exit_iter0_state8_assign_proc : process(icmp_ln22_fu_134_p2)
    begin
        if ((icmp_ln22_fu_134_p2 = ap_const_lv1_0)) then 
    ...
    icmp_ln22_fu_134_p2 <= "1" when (signed(zext_ln22_fu_130_p1) < signed(len)) else "0";
    ...
    in1_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln22_reg_157, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln22_reg_157 = ap_const_lv1_1))) then 
    ...
    in1_blk_n_R_assign_proc : process(m_axi_in1_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln22_reg_157)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln22_reg_157 = ap_const_lv1_1))) then 
    ...
    weight_1_vld_in_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln22_reg_157, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln22_reg_157 = ap_const_lv1_1))) then 
    ...
    weight_TDATA_blk_n_assign_proc : process(weight_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln22_reg_157, ap_enable_reg_pp0_iter2, icmp_ln22_reg_157_pp0_iter1_reg)
    begin
        if ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln22_reg_157_pp0_iter1_reg = ap_const_lv1_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln22_reg_157 = ap_const_lv1_1)))) then 
    ...
    zext_ln22_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_98),32));
end behav;
