...
architecture behav of a0_s2mm_data_copy is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "a0_s2mm_data_copy,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z045-ffg900-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=654,HLS_SYN_LUT=675,HLS_VERSION=2019_1}";
    ...
    signal icmp_ln32_reg_168 : STD_LOGIC_VECTOR (0 downto 0);
    signal buf_r_blk_n_B : STD_LOGIC;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal icmp_ln34_reg_182 : STD_LOGIC_VECTOR (0 downto 0);
    signal fifo_TDATA_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal icmp_ln32_fu_140_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln34_fu_151_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln32_fu_136_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_idle_pp0 : STD_LOGIC;
    signal ap_enable_pp0 : STD_LOGIC;

    component a0_s2mm_data_copy_buf_r_m_axi IS
    generic (
...
begin
    s2mm_data_copy_buf_r_m_axi_U : component a0_s2mm_data_copy_buf_r_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln32_reg_168 <= icmp_ln32_fu_140_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                icmp_ln34_reg_182 <= icmp_ln34_fu_151_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state8, icmp_ln34_reg_182, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2, buf_r_AWREADY, buf_r_BVALID, icmp_ln34_fu_151_p2, ap_CS_fsm_state4, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_140_p2 = ap_const_lv1_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_140_p2 = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln34_fu_151_p2 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state8 => 
                if ((not(((buf_r_BVALID = ap_const_logic_0) and (icmp_ln34_reg_182 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state8;
                end if;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(fifo_0_vld_out, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2)
    begin
                ap_block_pp0_stage0_01001 <= ((fifo_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(fifo_0_vld_out, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_11001 <= (((fifo_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1)) or ((ap_const_boolean_1 = ap_block_state3_io) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(fifo_0_vld_out, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2, ap_block_state3_io)
    begin
                ap_block_pp0_stage0_subdone <= (((fifo_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1)) or ((ap_const_boolean_1 = ap_block_state3_io) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_state2_pp0_stage0_iter0_assign_proc : process(fifo_0_vld_out, icmp_ln32_fu_140_p2)
    begin
                ap_block_state2_pp0_stage0_iter0 <= ((fifo_0_vld_out = ap_const_logic_0) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1));
    end process;


    ap_block_state3_io_assign_proc : process(icmp_ln32_reg_168, buf_r_WREADY)
    begin
                ap_block_state3_io <= ((buf_r_WREADY = ap_const_logic_0) and (icmp_ln32_reg_168 = ap_const_lv1_1));
    end process;

        ap_block_state3_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state8_assign_proc : process(icmp_ln34_reg_182, buf_r_BVALID)
    begin
                ap_block_state8 <= ((buf_r_BVALID = ap_const_logic_0) and (icmp_ln34_reg_182 = ap_const_lv1_0));
    end process;


    ap_condition_pp0_exit_iter0_state2_assign_proc : process(icmp_ln32_fu_140_p2)
    begin
        if ((icmp_ln32_fu_140_p2 = ap_const_lv1_0)) then 
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state8, icmp_ln34_reg_182, buf_r_BVALID)
    begin
        if ((not(((buf_r_BVALID = ap_const_logic_0) and (icmp_ln34_reg_182 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state8, icmp_ln34_reg_182, buf_r_BVALID)
    begin
        if ((not(((buf_r_BVALID = ap_const_logic_0) and (icmp_ln34_reg_182 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    buf_r_BREADY_assign_proc : process(ap_CS_fsm_state8, icmp_ln34_reg_182, buf_r_BVALID)
    begin
        if ((not(((buf_r_BVALID = ap_const_logic_0) and (icmp_ln34_reg_182 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln34_reg_182 = ap_const_lv1_0))) then 
    ...
    buf_r_WVALID_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln32_reg_168, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln32_reg_168 = ap_const_lv1_1))) then 
    ...
    buf_r_blk_n_B_assign_proc : process(m_axi_buf_r_BVALID, ap_CS_fsm_state8, icmp_ln34_reg_182)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln34_reg_182 = ap_const_lv1_0))) then 
    ...
    buf_r_blk_n_W_assign_proc : process(m_axi_buf_r_WREADY, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln32_reg_168)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln32_reg_168 = ap_const_lv1_1))) then 
    ...
    fifo_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1))) then 
    ...
    fifo_TDATA_blk_n_assign_proc : process(fifo_0_state, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter0, icmp_ln32_fu_140_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln32_fu_140_p2 = ap_const_lv1_1))) then 
    ...
    icmp_ln32_fu_140_p2 <= "1" when (signed(zext_ln32_fu_136_p1) < signed(len)) else "0";
    icmp_ln34_fu_151_p2 <= "1" when (len = ap_const_lv32_0) else "0";
    zext_ln32_fu_136_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_104),32));
end behav;
