...
reg   [0:0] icmp_ln32_reg_168;
reg    buf_r_blk_n_B;
wire    ap_CS_fsm_state8;
reg   [0:0] icmp_ln34_reg_182;
reg    fifo_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln32_fu_140_p2;
reg    buf_r_AWVALID;
wire    buf_r_AWREADY;
reg    buf_r_WVALID;
wire    buf_r_WREADY;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln32_fu_140_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln32_fu_140_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((icmp_ln32_fu_140_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((~((buf_r_BVALID == 1'b0) & (icmp_ln34_reg_182 == 1'd0)) & (1'b1 == ap_CS_fsm_state8))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((~((buf_r_BVALID == 1'b0) & (icmp_ln34_reg_182 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (icmp_ln34_reg_182 == 1'd0))) begin
        buf_r_BREADY = 1'b1;
    end else begin
        buf_r_BREADY = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln32_reg_168 == 1'd1))) begin
        buf_r_WVALID = 1'b1;
    end else begin
        buf_r_WVALID = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln34_reg_182 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln32_reg_168 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln32_fu_140_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_140_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_140_p2 == 1'd0))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln34_fu_151_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((fifo_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_140_p2 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((fifo_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_140_p2 == 1'd1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((fifo_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln32_fu_140_p2 == 1'd1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((fifo_0_vld_out == 1'b0) & (icmp_ln32_fu_140_p2 == 1'd1));
end

always @ (*) begin
    ap_block_state3_io = ((buf_r_WREADY == 1'b0) & (icmp_ln32_reg_168 == 1'd1));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state8 = ((buf_r_BVALID == 1'b0) & (icmp_ln34_reg_182 == 1'd0));
end
...
assign icmp_ln32_fu_140_p2 = (($signed(zext_ln32_fu_136_p1) < $signed(len)) ? 1'b1 : 1'b0);

assign icmp_ln34_fu_151_p2 = ((len == 32'd0) ? 1'b1 : 1'b0);

assign zext_ln32_fu_136_p1 = i_0_reg_104;

endmodule //a0_s2mm_data_copy
